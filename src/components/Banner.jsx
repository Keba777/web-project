...
const Banner = () => {
  return (
    <div className="banner relative overflow-hidden max-w-screen-sm mx-auto md:max-w-none md:overflow-visible">
      {/* Top section */}
      <div className="pt-64 flex justify-evenly">
        <img src={card1} alt="card" className="w-48 md:w-64" />
      ...
      <div className="flex space-x-44">
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <button className="flex flex-col justify-center items-center gap-2 px-0 py-4 w-[167px] h-[52px] bg-white shadow-[0px_5px_30px_rgba(255,255,255,0.61)] rounded-[52px] text-black font-medium text-[16px] leading-none">
            Join Waitlist
          </button>
        </div>
