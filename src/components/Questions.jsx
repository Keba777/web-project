...
const Questions = () => {
  return (
    <section className="px-6 md:px-14 py-28 md:grid md:grid-cols-5 text-primary">
      <div className="col-span-2 pr-28">
        <h3 className="text-4xl md:text-[42px] md:leading-[42px] mb-5">What can curiosity, wonder, and awe do for you?</h3>
